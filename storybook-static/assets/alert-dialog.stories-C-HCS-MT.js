...
}`,...(ve=(Ce=O.parameters)==null?void 0:Ce.docs)==null?void 0:ve.source},description:{story:"shadcn 기본 버튼 + 코너 SVG 없음",...(ye=(we=O.parameters)==null?void 0:we.docs)==null?void 0:ye.description}}};const tr=["Default","WithCancel","WithCancelContactSupport","DestructiveConfirm","RequiredFieldsKo","WithPassword","WithSelect","LegacyPlain"];export{b as Default,_ as DestructiveConfirm,O as LegacyPlain,T as RequiredFieldsKo,N as WithCancel,S as WithCancelContactSupport,R as WithPassword,j as WithSelect,tr as __namedExportsOrder,er as default};
