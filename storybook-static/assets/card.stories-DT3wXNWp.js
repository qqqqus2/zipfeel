...
import { B as b } from "./button-BDfZ15N9.js";
import { c as g } from "./index-D1SQP9Z-.js";
import { I as J } from "./info-B03a6rtT.js";
import { c as L } from "./createLucideIcon-CfeEeys9.js";
...
const Y = g(
    ...
    Z = g("font-semibold leading-none tracking-tight", {
        variants: {
            variant: {
                default: "text-gray-6",
                hover: "text-point-2",
    ...
    s = e.forwardRef(({ className: r, variant: t = "default", ...a }, l) =>
        e.createElement(
            U.Provider,
            { value: t },
            e.createElement("div", {
                ref: l,
                "data-variant": t,
                className: n(Y({ variant: t }), r),
                ...a,
            }),
        ),
    );
s.displayName = "Card";
const f = e.forwardRef(({ className: r, ...t }, a) =>
    e.createElement("div", {
        ref: a,
        className: n("flex flex-col space-y-1.5 ", r),
        ...t,
    }),
);
f.displayName = "CardHeader";
const o = e.forwardRef(({ className: r, ...t }, a) => {
    const l = $();
    return e.createElement("div", {
        ref: a,
        className: n(Z({ variant: l }), r),
        ...t,
    });
});
o.displayName = "CardTitle";
const d = e.forwardRef(({ className: r, ...t }, a) => {
    const l = $();
    return e.createElement("div", {
        ref: a,
        className: n(ee({ variant: l }), r),
        ...t,
    });
});
d.displayName = "CardDescription";
const C = e.forwardRef(({ className: r, ...t }, a) =>
    e.createElement("div", { ref: a, className: n(r), ...t }),
);
C.displayName = "CardContent";
const v = e.forwardRef(({ className: r, ...t }, a) =>
    e.createElement("div", {
        ref: a,
...
f.__docgenInfo = { description: "", methods: [], displayName: "CardHeader" };
v.__docgenInfo = { description: "", methods: [], displayName: "CardFooter" };
...
C.__docgenInfo = { description: "", methods: [], displayName: "CardContent" };
const N = ["variant"],
    ce = {
        title: "UI/Card",
        component: s,
...
function i({ variant: r, description: t }) {
    return e.createElement(
        s,
        { variant: r, className: "w-full max-w-md" },
        e.createElement(
            "div",
            ...
            e.createElement(
                ...
                e.createElement(d, { className: "text-xs leading-snug" }, t),
            ),
            e.createElement(
                "div",
                ...
                r === "hover"
                    ? e.createElement(
                          ...
                          {
                              className:
                                  "inline-flex size-9 items-center justify-center rounded-full bg-point-2 text-white shadow-sm",
                              "aria-hidden": !0,
                          },
                          e.createElement(y, {
                              className: "size-4",
                ...
                r === "active"
                    ? e.createElement(
                          ...
                          {
                              className:
                                  "inline-flex size-9 items-center justify-center rounded-full bg-black/25 text-white shadow-inner",
                              "aria-hidden": !0,
                          },
                          e.createElement(y, {
                              className: "size-4",
                    ...
                    : null,
                r === "default" || r === "filled" || r === "disabled"
                    ? e.createElement(X, {
                          className: n(
                              "size-9",
                              r === "filled" ? "text-gray-6" : "text-gray-4",
                          ),
                          strokeWidth: 1.75,
                          "aria-hidden": !0,
                      })
        ...
        render: () =>
            e.createElement(
                ...
                e.createElement(
                    ...
                    e.createElement(b, { type: "button", size: "sm" }, "확인"),
                ),
            ),
    },
    m = {
        render: () =>
            e.createElement(
                ...
                e.createElement(
                    f,
                    null,
                    e.createElement(o, null, "알림"),
                    e.createElement(d, null, "설명 한 줄"),
                ),
            ),
    },
    p = {
    ...
    u = {
        render: () =>
            e.createElement(
                ...
                {
                    className:
                        "grid w-full max-w-3xl grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3",
                },
                ["첫째", "둘째", "셋째"].map((r) =>
                    e.createElement(
                        s,
                        ...
                        e.createElement(
                            f,
                            { className: "pb-3" },
                            e.createElement(o, { className: "text-base" }, r),
                            e.createElement(d, null, "짧은 부가 설명"),
                        ),
                        e.createElement(
                            C,
                            { className: "pb-6" },
...
x.parameters = {
  ...
  parameters: {
    layout: "padded"
            ...
            ...((w = (E = x.parameters) == null ? void 0 : E.docs) == null
                ? void 0
                : w.source),
        },
    },
...
c.parameters = {
  ...
  render: () => <Card className="w-full max-w-md">\r
      <CardHeader>\r
        ...
        <CardDescription>\r
          부가 설명은 <code className="text-gray-6">CardDescription</code>\r
          에 넣습니다.\r
        </CardDescription>\r
      </CardHeader>\r
      <CardContent>\r
      ...
      <CardFooter className="gap-2">\r
        ...
        <Button type="button" size="sm">\r
          확인\r
            ...
            ...((D = (k = c.parameters) == null ? void 0 : k.docs) == null
                ? void 0
                : D.source),
        },
        description: {
            story: "헤더·본문·푸터를 모두 쓰는 기본 패턴",
            ...((S = (z = c.parameters) == null ? void 0 : z.docs) == null
                ? void 0
                : S.description),
        },
    },
  ...
  render: () => <Card className="w-full max-w-sm">\r
      <CardHeader>\r
        ...
        <CardDescription>설명 한 줄</CardDescription>\r
            ...
            ...((V = (T = m.parameters) == null ? void 0 : T.docs) == null
                ? void 0
                : V.source),
        },
        description: {
            story: "제목만 있는 간단한 카드",
            ...((R = (I = m.parameters) == null ? void 0 : I.docs) == null
                ? void 0
                : R.description),
        },
    },
      ...
      <CardContent className="pt-6">\r
        <p className="text-sm">\r
          ...
          에만 패딩을 주어 헤더 없이 쓸 수 있습니다.\r
            ...
            ...((F = (B = p.parameters) == null ? void 0 : B.docs) == null
                ? void 0
                : F.source),
        },
        description: {
            story: "본문만 (헤더 없이)",
            ...((M = (j = p.parameters) == null ? void 0 : j.docs) == null
                ? void 0
                : M.description),
        },
    },
...
u.parameters = {
  ...
  parameters: {
    layout: "padded"
            ...
            ...((P = (G = u.parameters) == null ? void 0 : G.docs) == null
                ? void 0
                : P.source),
        },
        description: {
            story: "그리드에 여러 장 배치 예시",
            ...((A = (q = u.parameters) == null ? void 0 : q.docs) == null
                ? void 0
                : A.description),
        },
    },
