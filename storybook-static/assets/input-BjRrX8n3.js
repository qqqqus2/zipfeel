...
const c =
    ...
    d = "shrink-0 text-sm font-medium text-gray-6 select-none",
    g =
        ...
        (
            ...
            (n != null && n !== "") || (t != null && t !== "")
                ? e.createElement(
                      ...
                      n ? e.createElement("span", { className: d }, n) : null,
                      ...
                      t ? e.createElement("span", { className: d }, t) : null,
                  )
                : e.createElement("input", {
                      type: i,
                      disabled: r,
                      className: l(
                          "flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-gray-6 placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
                          g,
                          o,
                      ),
                      ref: a,
...
u.displayName = "Input";
u.__docgenInfo = { description: "", methods: [], displayName: "Input" };
export { u as I };
