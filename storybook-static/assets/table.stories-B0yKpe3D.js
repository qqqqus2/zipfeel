import { r as e } from "./index-DRjF_FHU.js";
import { c as b } from "./utils-BQHNewu7.js";
import { B as k } from "./button-BDfZ15N9.js";
import { C as ce } from "./chevron-up-C7cuxkgF.js";
import { C as me } from "./chevron-down-CqCF4uWS.js";
import { c as A } from "./createLucideIcon-CfeEeys9.js";
import { C as ue } from "./chevrons-up-down-DPQ0pap0.js";
import { P as fe } from "./pencil-BUJrXowq.js";
import "./index-oDCx3a8o.js";
import "./index-Bms3GI6n.js";
import "./jsx-runtime-DiklIkkE.js";
...
function ke(t) {
    return typeof t != "string"
        ...
        : t
              .trim()
              .split(/\s+/)
              .some((a) => /^(?:w|min-w|max-w|basis)-/.test(a));
}
const D = {
    auto: "auto",
    content: "max-content",
...
function B(t) {
    if (t != null && t.width) return { track: t.width };
    const a = t == null ? void 0 : t.size;
    if (a != null && D[a] != null) return { track: D[a] };
    if (a != null && typeof a == "string") {
        const r = a.trim();
        if (r && ke(r)) return { track: "auto", sizeClassName: r };
        if (r) return { track: r };
    }
    return { track: D.default };
}
function Ce(t = [], a) {
    return (
        a || (t.length ? t.map((r) => B(r).track).join(" ") : "minmax(0, 1fr)")
    );
}
function Se(t, a) {
    return { gridTemplateColumns: Ce(t, a) };
}
function J(t) {
    return t == null || t === ""
        ? "center"
...
function _e({ col: t, isLastColumn: a = !1 }) {
    const r = we(),
        l = t.sortKey ?? t.key,
        n = t.sortable === !1,
        s = !!(r.tableSortable && l && !n),
        i = s ? r.getSortState(l) : !1,
        o = J(t.headerAlign ?? t.sortAlign ?? "center"),
        u = J(t.sortAlign ?? t.headerAlign ?? "center"),
        c = W(o),
        d = Te(o),
        f = W(u),
        { sizeClassName: x } = B(t),
    ...
    return s
        ? e.createElement(
              ...
              e.createElement(
                  ...
                  e.createElement(Ee, { direction: i }),
              ),
          )
        : e.createElement(
              "div",
              { role: "columnheader", className: y },
              e.createElement(
                  "span",
                  { className: "min-w-0 truncate" },
                  t.header,
...
const q = e.forwardRef(
    (
        { className: t, children: a, style: r, selected: l, value: n, ...s },
        i,
    ) => {
        const { gridStyle: o } = re(),
            u = e.useContext(ae),
            { "data-state": c, onClick: d, ...f } = s,
            x = l !== void 0,
            y = !x && u && n !== void 0 && u.selectedKey === n,
            h = x ? l === !0 : y,
            N = (T) => {
                (d == null || d(T),
                    !x &&
                        u &&
                        n !== void 0 &&
                        u.setSelectedKey((C) => (C === n ? null : n)));
            },
            g = typeof d == "function" || (!x && u && n !== void 0);
        return e.createElement(
            "div",
            {
                ref: i,
                ...
                className: b(
                    ...
                    g && "cursor-pointer [&_[role=cell]]:cursor-pointer",
                    t,
...
q.displayName = "TableGridRow";
function z({ columnKey: t, className: a, children: r, ...l }) {
    const { columns: n } = re(),
        s = n.find((o) => o.key === t),
        { sizeClassName: i } = B(s ?? {});
    return e.createElement(
        "div",
        {
            ...
            className: b(
                ...
                s == null ? void 0 : s.cellClassName,
                s == null ? void 0 : s.mobileClassName,
                i,
                a,
            ),
            ...l,
...
function K({
    ...
    sorting: u,
    onSortingChange: c,
    defaultSorting: d = null,
}) {
    const [f, x] = e.useState(null),
        [y, h] = e.useState(d),
        N = u !== void 0,
        m = N ? u : y,
        g = e.useCallback(
            (p) => {
                const E = typeof p == "function" ? p(m) : p;
                N ? c == null || c(E) : h(E);
            },
            [N, m, c],
        ),
        ...
        _ = e.useMemo(() => Se(t, a), [t, a]),
        w = e.useMemo(
            () => ({ columns: t, columnTemplate: a, gridStyle: _ }),
            [t, a, _],
        ),
        v = e.useMemo(
            () =>
                i
                    ? e.Children.map(r, (p, E) =>
                          !e.isValidElement(p) || p.type !== q
                              ? p
                              : e.cloneElement(p, {
                                    className: b(
                                        p.props.className,
        ...
        S = s
            ? e.createElement(
                  ae.Provider,
                  { value: { selectedKey: f, setSelectedKey: x } },
                  v,
              )
            : v,
        O = e.createElement(
            ...
            e.createElement(
                ...
                e.createElement(
                    "div",
                    { role: "table", className: "w-full text-sm" },
                    e.createElement(
                        "div",
                        { role: "rowgroup", className: "hidden md:block" },
                        e.createElement(
                            "div",
                            {
                                role: "row",
                                style: _,
                                className:
                                    "grid h-[30px] min-h-[30px] border-b border-black bg-gray-2 font-bold text-gray-6",
                            },
                            t.map((p, E) =>
                                e.createElement(_e, {
                                    key: p.key,
                                    col: p,
                                    isLastColumn: E === t.length - 1,
                                }),
                            ),
                        ),
                    ),
    ...
    return e.createElement(
        "div",
        { className: b("w-full overflow-auto", l) },
        n
            ? e.createElement(
                  "div",
...
K.__docgenInfo = {
    ...
    methods: [],
    displayName: "TableGrid",
    props: {
        columns: { defaultValue: { value: "[]", computed: !1 }, required: !1 },
        bordered: {
...
function oe(t, a, r) {
    if (!a || !Array.isArray(t) || t.length === 0) return t;
    const { id: l, desc: n } = a,
        s = (i, o) => i[o];
    return [...t].sort((i, o) => {
        const u = s(i, l),
...
function ze(t, a) {
    return Object.is(t, a) || (t == null && a == null)
        ? 0
        : t == null
          ? 1
          : a == null
            ? -1
            : typeof t == "number" && typeof a == "number"
              ? t - a
              : String(t).localeCompare(String(a), void 0, { numeric: !0 });
}
    ...
    (
        {
            ...
            sorting: r,
            onSortingChange: l,
            defaultSorting: n = null,
            children: s,
            ...i
        },
        o,
    ) => {
        const [u, c] = e.useState(n),
            d = r !== void 0,
            f = d ? r : u,
            x = e.useCallback(
                (m) => {
                    const g = typeof m == "function" ? m(f) : m;
                    d ? l == null || l(g) : c(g);
                },
                [d, f, l],
            ),
...
M.displayName = "Table";
const H = e.forwardRef(({ className: t, ...a }, r) =>
...
const L = e.forwardRef(
    ({ className: t, selectable: a = !0, children: r, ...l }, n) => {
        const [s, i] = e.useState(null);
        let o = 0;
        const u = a
                ? e.Children.map(r, (d) => {
                      if (!e.isValidElement(d)) return d;
                      const f = d.props.value !== void 0 ? d.props.value : o++;
                      return e.cloneElement(d, { value: f });
                  })
                : r,
            c = e.createElement(
                "tbody",
        ...
        return a
            ? e.createElement(
                  le.Provider,
                  { value: { selectedKey: s, setSelectedKey: i } },
                  c,
              )
            : c;
    },
...
const de = e.forwardRef(({ className: t, ...a }, r) =>
...
const G = e.forwardRef(({ className: t, selected: a, value: r, ...l }, n) => {
    const s = e.useContext(le),
        { "data-state": i, onClick: o, ...u } = l,
        c = a !== void 0,
        d = !c && s && r !== void 0 && s.selectedKey === r,
        f = c ? a === !0 : d,
        x = (N) => {
            (o == null || o(N),
                !c &&
                    s &&
                    r !== void 0 &&
                    s.setSelectedKey((m) => (m === r ? null : r)));
        },
        h = typeof o == "function" || (!c && s && r !== void 0);
    return e.createElement("tr", {
        ref: n,
        onClick: x,
        "data-state": f ? "selected" : i,
        "aria-selected": f ? !0 : void 0,
        className: b(
            "border-b bg-white transition-colors",
            h && "cursor-pointer [&_td]:cursor-pointer",
            t,
...
const U = e.forwardRef(
    (
        ...
        const o = e.useContext(se),
            u = a === !1,
            c = !!(o != null && o.tableSortable && r && !u),
            d = c ? o.getSortState(r) : !1,
            f =
                l === "end"
                    ? "justify-end"
                    : l === "start"
        ...
        return c
            ? e.createElement(
                  ...
                  e.createElement(
                      ...
                      e.createElement(ne, { direction: d }),
                  ),
              )
            : e.createElement(
                  "th",
...
const j = e.forwardRef(({ className: t, stackLabel: a, ...r }, l) =>
    e.createElement("td", {
        ref: l,
        "data-label": a,
        className: b(
...
const ie = e.forwardRef(({ className: t, ...a }, r) =>
    e.createElement("caption", {
        ref: r,
        className: b("mt-4 text-sm text-muted-foreground", t),
        ...a,
    }),
);
ie.displayName = "TableCaption";
function P({ columns: t, className: a, ...r }) {
    return e.createElement(
        G,
        { className: a, ...r },
        t.map((l) =>
            e.createElement(
                ...
                {
                    key: l.key,
                    sortKey: l.sortable === !1 ? void 0 : l.key,
                    sortable: l.sortable,
                    sortAlign: l.sortAlign ?? "center",
...
P.displayName = "TableHeaderRowFromColumns";
function F({
    data: t,
    columns: a,
    sortable: r = !1,
    ...
    className: f,
    tableClassName: x,
    headerRowClassName: y = "bg-muted/50 hover:bg-muted/50",
}) {
    const [h, N] = e.useState(s),
        m = l !== void 0,
        g = m ? l : h,
        T = m ? n : N,
        C = e.useMemo(() => (!r || !g ? (t ?? []) : oe(t ?? [], g)), [t, r, g]),
        V = e.useCallback(
            (w, v) => (typeof i == "function" ? i(w, v) : w[i]),
            [i],
        ),
        _ = e.createElement(
            M,
            ...
            e.createElement(
                H,
                null,
                e.createElement(P, { columns: a, className: y }),
            ),
            e.createElement(
                L,
                { selectable: o },
                C.length
                    ...
                    : e.createElement(
                          G,
                          null,
                          e.createElement(j, { colSpan: a.length }, c),
                      ),
            ),
        );
    return e.createElement(
        "div",
        { className: b("w-full", f) },
        d
            ? e.createElement(
                  "div",
                  { className: "overflow-hidden rounded-md border" },
...
H.__docgenInfo = { description: "", methods: [], displayName: "TableHeader" };
L.__docgenInfo = {
    description:
...
de.__docgenInfo = { description: "", methods: [], displayName: "TableFooter" };
U.__docgenInfo = {
    description:
...
ie.__docgenInfo = { description: "", methods: [], displayName: "TableCaption" };
ne.__docgenInfo = {
    description:
...
P.__docgenInfo = {
    ...
    methods: [],
    displayName: "TableHeaderRowFromColumns",
};
F.__docgenInfo = {
    description:
    ...
    props: {
        ...
        rowKey: { defaultValue: { value: '"id"', computed: !1 }, required: !1 },
        selectable: {
            defaultValue: { value: "true", computed: !1 },
            required: !1,
        },
        ...
        headerRowClassName: {
            defaultValue: {
                value: '"bg-muted/50 hover:bg-muted/50"',
                computed: !1,
            },
            required: !1,
        },
...
const Q = ["sortable", "sorting", "onSortingChange", "defaultSorting"],
    Je = {
        title: "UI/Table",
        component: M,
        parameters: {
...
그리드형 복합 행은 \`TableGrid\` 스토리를 참고하세요.`,
        ...
        argTypes: {
            ...
            onSortingChange: { control: !1, description: "정렬 변경 시 콜백" },
        },
    },
    Re = [
        {
                ...
                e.createElement(
                    ...
                    e.createElement(
                        ...
                        e.createElement(
                            ...
                            {
                                className:
                                    "flex flex-wrap items-center gap-1 [&>p+p]:before:inline-block [&>p+p]:before:shrink-0 [&>p+p]:before:text-muted-foreground [&>p+p]:before:content-['·']",
                            },
                            e.createElement(
                                "p",
                    ...
                    e.createElement(
                        ...
                        e.createElement(
                            ...
                            e.createElement(R, { className: "size-4" }),
                            "보기",
                        ),
                        e.createElement(
                            k,
...
function Ie({ row: t }) {
    ...
    const a = Math.max(
        0,
        (((r = t.metaLines) == null ? void 0 : r.length) ?? 0) - 1,
    );
    return e.createElement(
        "div",
        {
            className:
                "flex min-w-0 flex-1 flex-col gap-2 py-1 md:flex-row md:items-center md:justify-between md:gap-2",
        },
        e.createElement(
            "div",
            ...
            e.createElement(
                ...
                {
                    className:
                        "flex min-w-0 flex-nowrap items-center gap-x-1 text-xs text-muted-foreground",
                },
                t.metaLines.map((l, n) =>
                    e.createElement(
                        e.Fragment,
                        ...
                        e.createElement(
                            ...
                            e.createElement(
                                "span",
                                { className: "shrink-0 font-bold text-gray-6" },
                                l.label,
                            ),
                            e.createElement(
                                "span",
            ...
            e.createElement(
                ...
                {
                    className:
                        "m-0 min-w-0 text-sm font-bold max-md:whitespace-normal max-md:break-words md:truncate",
                },
                t.title,
            ),
            e.createElement(
                ...
                {
                    className:
                        "m-0 min-w-0 text-xs text-muted-foreground max-md:whitespace-normal max-md:break-words md:truncate",
                },
                t.summary,
            ),
        ),
        e.createElement(
            ...
            e.createElement(
                ...
                e.createElement($, { className: "size-4" }),
            ),
            e.createElement(
                k,
                {
                ...
                e.createElement(fe, { className: "size-4" }),
            ),
            e.createElement(
                k,
                {
        ...
        e.createElement(
            ...
            {
                className:
                    "flex w-full flex-wrap items-center justify-between gap-x-1 gap-y-2 md:hidden",
            },
            e.createElement(
                k,
                { type: "button", variant: "ghost", size: "sm" },
            ...
            e.createElement(
                k,
                { type: "button", variant: "ghost", size: "sm" },
                e.createElement(ve, { className: "size-4" }),
                "과거 이력",
            ),
            e.createElement(
                k,
...
function je() {
    const [t, a] = e.useState(null),
        r = e.useMemo(() => oe(Re, t), [t]);
    return e.createElement(
        "div",
        { className: "mx-auto flex max-w-3xl flex-col gap-14 py-2" },
        e.createElement(
            "section",
            { className: "space-y-2" },
            e.createElement(
                "h3",
                { className: "text-sm font-semibold text-gray-6" },
                e.createElement(
                    "code",
            ...
            e.createElement(
                ...
                "복잡한 셀만 ",
                e.createElement("code", null, "render"),
                "로 넘기면 됩니다. 정렬은 내부 상태(또는",
                " ",
                e.createElement("code", null, "sorting"),
                " / ",
                e.createElement("code", null, "onSortingChange"),
                "로 제어).",
            ),
            e.createElement(F, {
                data: Ge,
                    ...
                    e.createElement(
                        ...
                        e.createElement(
                            ...
                            e.createElement(
                                ...
                                {
                                    className:
                                        "flex items-start gap-2 md:contents",
                                },
                                e.createElement(
                                    "span",
                                    {
                                        className:
                                            "hidden text-xs font-medium text-muted-foreground max-md:inline-block max-md:[writing-mode:vertical-rl] max-md:leading-tight",
                                    },
                                    "회차",
                                ),
                                e.createElement(
                                    "span",
                                    { className: "md:tabular-nums" },
                                    l.id,
                                ),
                            ),
                        ),
                        e.createElement(
                            z,
                            { columnKey: "role", className: "justify-center" },
                            l.role,
                        ),
                        e.createElement(
                            z,
                        ...
                        e.createElement(
                            z,
                            { columnKey: "name", className: "min-w-0" },
                            e.createElement(Ie, { row: l }),
                        ),
                    ),
                ),
            ),
...
const I = { render: () => e.createElement(je, null) };
var X, Y, Z;
I.parameters = {
    ...I.parameters,
    docs: {
  ...
  render: () => <TableStoriesDemo />
            ...
            ...((Z = (Y = I.parameters) == null ? void 0 : Y.docs) == null
                ? void 0
                : Z.source),
        },
    },
...
const We = ["Default"];
export { I as Default, We as __namedExportsOrder, Je as default };
