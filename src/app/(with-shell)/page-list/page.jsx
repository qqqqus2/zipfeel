            ...
            <Table>
                ...
                <TableBody>
                    {pageListData.map((page) => {
                        const isClickable =
                            page.status === "완료" || page.status === "진행중";
                        ...
                        return (
                            <TableRow
                                ...
                                className={
                                    isClickable
                                        ? "hover:bg-gray-1/50 cursor-pointer"
                                        : ""
                                }
            ...
            <div className="flex items-start justify-between">
                <div>
                    ...
                    <p className="text-gray-5">
                        Zipfeel 프로젝트의 모든 페이지 및 개발 현황을 확인할 수
                        있습니다.
                    </p>
                </div>
                <Link
                    href="/main"
                    className="text-sm font-medium text-point-2 flex items-center gap-1 hover:underline shrink-0"
                >
