        ...
        <AlertDialog>
            ...
            <AlertDialogContent cornerArtVariant="confirm">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        The app will restart with the new language. You can
                        change it again in settings.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
        ...
        <AlertDialog>
            ...
            >
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        You can reach our support team from the app settings.
                        Continue to open the help center?
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action requires verification. Type your password to
                        continue.
                    </AlertDialogDescription>
                </AlertDialogHeader>
        ...
        <AlertDialog>
            ...
            <AlertDialogContent showCornerArt={false}>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        <code>{"showCornerArt={false}"}</code> · 회색 버튼
                        variant.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
