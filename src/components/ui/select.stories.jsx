...
export const Disabled = {
    ...
    render: () => (
        <div className="w-[300px] space-y-4">
            ...
            <div>
                <label className="text-sm font-medium mb-2 block">
                    Disabled with innerLabel and required
                </label>
                <Select disabled>
                    <SelectTrigger innerLabel="과일" required className="w-full">
            ...
            <div>
                ...
                <Select disabled defaultValue="banana">
                    <SelectTrigger innerLabel="과일" className="w-full">
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                        <SelectItem value="apple">Apple</SelectItem>
        ...
        <div className="w-[300px] space-y-4">
            <div>
                ...
                <Select defaultValue="typescript">
                    <SelectTrigger innerLabel="항목명" required>
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div>
                <label className="text-sm font-medium mb-2 block">
                    Experience Level (innerLabel only)
                </label>
                <Select>
                    <SelectTrigger innerLabel="레벨">
