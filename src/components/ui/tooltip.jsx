  ...
  ({ className, sideOffset = 4, children, ...props }, ref) => (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 max-w-[min(330px,calc(100vw-1.5rem))] overflow-visible rounded-md bg-gray-6 px-[20px] py-3 text-[14px] text-white",
      ...
      >
        {children}
        <TooltipPrimitive.TooltipArrow className="fill-gray-6" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  ),
);
